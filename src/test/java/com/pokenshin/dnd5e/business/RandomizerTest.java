...
class RandomizerTest {
    ...
    @Test
    void getRandomStartingEquipmentRanger(){
        CharacterClass ranger = new CharacterClass();
        ranger.setName("Ranger");
        ArrayList<Item> result = randomizer.getRandomStartingEquipment(ranger);
        assertNotNull(result);
        assertTrue(result.size() > 0);
    }

    @Test
    void getRandomStartingEquipmentRogue(){
        CharacterClass rogue = new CharacterClass();
        rogue.setName("Rogue");
        ArrayList<Item> result = randomizer.getRandomStartingEquipment(rogue);
        assertNotNull(result);
        assertTrue(result.size() > 0);
    }
